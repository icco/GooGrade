...
public class Permissions implements java.io.Serializable
{
    ...
    public Permissions()
    {
	  ...
	  */
	 public boolean setSendEmail(boolean pSendEmail)
	 {
		 return false;
	 } 
	  ...
	  * @return true if set is succesful, false if not
	  */
	 public boolean setUploadFile(boolean pUploadFile)
	 {
		 return false;
	 }
	  ...
	  * @return true if set is succesful, false if not
	  */
	 public boolean setViewOwnGrade(boolean pViewOwnGrade)
	 {
		 return false;
	 }
	  ...
	  * @return true if set is succesful, false if not
	  */
	 public boolean setManageMetric(boolean pManageMetric)
	 {
		 return false;
	 }
	  ...
	  * @return true if set is succesful, false if not
	  */
	 public boolean setManageGrade(boolean pManageGrade)
	 {
		 return false;
	 }
	  ...
	  * @return true if set is succesful, false if not
	  */
	 public boolean setManageRoster(boolean pManageRoster)
	 {
		 return false;
	 }
	  ...
	  * @return true if set is succesful, false if not
	  */
	 public boolean setManageAnnouncement(boolean pManageAnnouncement)
	 {
		 return false;
	 }
	  ...
	  * @return true if set is succesful, false if not
	  */
	 public boolean setManageUser(boolean pManageUser)
	 {
		 return false;
	 }
}
